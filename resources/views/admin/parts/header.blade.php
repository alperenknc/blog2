    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-none d-lg-flex align-items-center mr-3">
            ...
            <a href="{{ route('admin.panel') }}">
                <img alt="Logo" src="{{ asset('admin/assets/media/logos/logo-letter-1.png') }}" class="logo-sticky max-h-35px" />
            </a>
            <!--end::Logo-->
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item " >
                    <div class="btn btn-primary font-weight-bolder" onclick="window.open('{{ route('pages.anasayfa') }}')" style="margin-right: 0.5rem;">Siteye Git</div>
                </div>
