    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">Web Application Developer</div>
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                    ...
                    <a href="{{ route('admin.cikis.post') }}" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5">Çıkış Yap</a>
                </div>
            </div>
        </div>
        <!--end::Header-->
