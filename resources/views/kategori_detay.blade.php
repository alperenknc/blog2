                        ...
                        <div class="post-sayt">
                            <div class="medium-post-box clearfix">
                                <div class="pm-top-info clearfix">
                                    <div class="pull-left">
                                        <a href="{{ route('pages.kategoriler.detay',[Str::slug($konu->kategoriler->baslik),$konu->kategoriler->id]) }}">{{ $konu->kategoriler->baslik }}</a>
                                    </div>
                                ...
                                <div class="post-item-paragraph">
                                    ...
                                    <p class="ellipsis-readmore">{!! Str::limit(strip_tags($konu->yazi),80) !!}
